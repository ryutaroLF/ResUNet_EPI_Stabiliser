...
def save_featuremap_280(tensor,save_directory_path,name):
...
class EPINET(nn.Module):
    ...
    def forward(self, x_0d, x_90d, x_45d, x_m45d):
        ...
        save_featuremap(x_0d_1,"./hidden_output/multistream","x_0d_1")
        save_featuremap(x_0d_2,"./hidden_output/multistream","x_0d_2")
        save_featuremap(x_0d_3,"./hidden_output/multistream","x_0d_3")
        save_featuremap(x_90d_1,"./hidden_output/multistream","x_90d_1")
        save_featuremap(x_90d_2,"./hidden_output/multistream","x_90d_2")
        save_featuremap(x_90d_3,"./hidden_output/multistream","x_90d_3")
        save_featuremap(x_45d_1,"./hidden_output/multistream","x_45d_1")
        save_featuremap(x_45d_2,"./hidden_output/multistream","x_45d_2")
        save_featuremap(x_45d_3,"./hidden_output/multistream","x_45d_3")
        save_featuremap(x_m45d_1,"./hidden_output/multistream","x_m45d_1")
        save_featuremap(x_m45d_2,"./hidden_output/multistream","x_m45d_2")
        save_featuremap(x_m45d_3,"./hidden_output/multistream","x_m45d_3")

        save_featuremap_280(x_1,"./hidden_output/multistream","x_1")
        save_featuremap_280(x_2,"./hidden_output/multistream","x_2")
        save_featuremap_280(x_3,"./hidden_output/multistream","x_3")
        save_featuremap_280(x_4,"./hidden_output/multistream","x_4")
        save_featuremap_280(x_5,"./hidden_output/multistream","x_5")
        save_featuremap_280(x_6,"./hidden_output/multistream","x_6")
        save_featuremap_280(x_7,"./hidden_output/multistream","x_7")
        save_single_tensor(x_8,"./hidden_output/multistream","x_8")
